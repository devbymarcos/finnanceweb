"use server";
import { z } from "zod";
import { deleteInvoiceApi, putWalletApi } from "@/http/api";
...
const schema = z.object({
  name: z.string().min(8, "Insira um nome para carteira"),
  description: z
    .string()
    .min(8, "Escreva uma descrição com no minimo 8 caracteres"),
});
